...
import numpy as np
import tqdm
from data import convert_to_features
...
tokenizer, model = load_model_and_tokenizer(model_name='model_finetune_deberta_lr2e5_rerun/checkpoint_0_step_1722')
model.eval()
...
plt.savefig('finetune_deberta.png')
